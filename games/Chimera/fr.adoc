...
* En commençant par la Chimère, chacun·e à l'opportunité de poser jusqu'à 3 cartes sur la table, si ce n'est pas déjà fait.
...
Celui·Celle qui a le plus de cartes face visible choisit quelles cartes sont échangées, et quelles cartes sont reprises en main.
...
Celles·ceux qui ont placé trop de cartes face visible choisissent lesquelles de leur cartes sont échangées, et lesquelles sont reprises en main.
...
.Score à 5 jou·eur·euse·s
====
*La mise est de 50, la Chimère est la première à avoir vidé sa main, le Pi Ya a vidé sa main en second, deux Pièges ont été joué et deux Chasseurs n'ont pas joué de cartes.*
...
* *À 3 jou·eur·euse·s :* Les Pièges et le Vol de la Chimère NE PEUVENT PAS être joué en dehors de votre tour.
